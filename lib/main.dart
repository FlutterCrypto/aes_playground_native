...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MainFormPage(title: 'AES Playground native'),
...
class _MainFormPageState extends State<MainFormPage> {
  ...
  Widget linkWidget() {
    return Container(
      ...
      child: Text(
        'Beschreibung des Programms: http://fluttercrypto.bplaced.net/aes-playground-native/',
        style: TextStyle(
          fontSize: 18,
          color: Colors.blue,
        ...
        child: Form(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  'Diese App demonstriert die symmetrische Verschlüsselung auf Basis des AES Algorithmus mit nativen Funktionen.',
                      ...
                      onPressed: () {
                        ...
                        LicenseRegistry.addLicense(() async* {
                          yield LicenseEntryWithLineBreaks(
                            ['FlutterCrypto AES Playground native'],
                ...
                Link(
                  ...
                  uri: Uri.parse('http://fluttercrypto.bplaced.net/aes-playground-native/'),

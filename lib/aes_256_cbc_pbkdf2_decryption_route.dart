...
class _MyFormPageState extends State<Aes256CbcPbkdf2DecryptionRoute> {
  ...
  Future<void> _aesCbcDec(String password, String ciphertextComplete) async {
    String returnString;
    final arguments = {'password' : password,
      'ciphertext' : ciphertextComplete};
    try {
      final String result = await methodChannel.invokeMethod('aesCbcDec', arguments);
      returnString = '$result';
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            String ciphertextComplete =
                                salt + ':' +
                                    iterationsString + ":" +
                                    iv + ':' + ciphertext;
                            await _aesCbcDec(password, ciphertextComplete);
                          } else {
